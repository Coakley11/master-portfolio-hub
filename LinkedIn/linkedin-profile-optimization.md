...
## Priority 2 — About section (paste-ready)
...
## Priority 3 — Featured section (order)

Pin in this order once portfolio URL is live:

1. **Portfolio Website** (public URL) — primary CTA for applications  
2. **Investment Explorer** live app or GitHub  
3. **Baseball Analytics** live app or GitHub  
4. **AMI** live app or GitHub  
5. Optional: AI Evaluator workbook PDF / repo folder if published

Use project screenshots from `Screenshots/` (same heroes as the website):
